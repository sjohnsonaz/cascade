Using Cascade requires only a few steps.  It's designed for TypeScript, but is completely compatible with pure JavaScript.  For the JavaScript startup guide, please see **Getting Started JavaScript**.
