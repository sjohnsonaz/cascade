import Cascade, { IObservable, Computed } from '..';
...
export default class DecoratorUtil {
     ...
     * @param thisArg
     */
    static createObservableIfNotExists<T>(
        obj: any,
        property: string,
    ...
    static attachObservable<T>(
        ...
        Object.defineProperty(target, propertyKey, {
            ...
            configurable: true,
            get: function () {
                return DecoratorUtil.createObservableIfNotExists(
                    this,
                    propertyKey,
                    factory,
                    undefined,
            ...
            set: readOnly
                ? undefined
                : function (value: T) {
                      DecoratorUtil.createObservableIfNotExists(
                          this,
                          propertyKey,
                          factory,
                          value,
